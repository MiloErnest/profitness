...
return new class extends Migration
{
    ...
    {
        Schema::create('supplements_monthly_reports', function (Blueprint $table) {
            $table->id();
            ...
            // Datos del producto
            $table->foreignId('supplement_id')->nullable()->constrained('supplements')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('supplements_monthly_reports');
    }
};
