...
return new class extends Migration
{
    ...
    {
        Schema::create('sport_clothes_monthly_reports', function (Blueprint $table) {
            $table->id();
            ...
            // Datos del producto
            $table->foreignId('sport_clothes_id')->nullable()->constrained('sports_clothes')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('sport_clothes_monthly_reports');
    }
};
