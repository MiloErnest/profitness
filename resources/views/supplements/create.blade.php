...
@section('title', 'Agregar Suplemento - Pro.Fitness')
    ...
    <div class="container mx-auto px-4 max-w-3xl">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-3xl font-bold text-gray-800">
                <i class="fas fa-plus-circle text-red-600 mr-2"></i>Agregar Nuevo Suplemento
            </h2>
            <p class="text-gray-600 mt-2">Completa la información del suplemento</p>
        </div>
            ...
            <form action="{{ route('supplements.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Ej: Whey Protein 100%, Creatina Monohidratada"
                           required>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div class="flex items-center">
                        ...
                        <p class="text-sm text-blue-800">
                            <span class="font-semibold">Stock disponible</span> se calcula automáticamente: Recibido - Vendido
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" 
                              rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                              placeholder="Describe el suplemento, beneficios, modo de uso..."></textarea>
                </div>
                ...
                <div class="flex gap-4">
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i>Guardar Suplemento
                    </button>
                    <a href="{{ route('supplements.admin') }}" 
